...
#define SAMPLE_DEVICE_NAME "ESP_TMP1_ADV"
...
uint8_t test_manufacturer_data[20];
...
static esp_ble_adv_data_t adv_data = {
    ...
    .appearance = 0x00,
    .manufacturer_len = 8, // TEST_MANUFACTURER_DATA_LEN,
    .p_manufacturer_data = test_manufacturer_data,
    .service_data_len = 0,
    .p_service_data = NULL,
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_ADV_START_COMPLETE_EVT:
        ...
        else
        {
            ...
            // Una vez que se inicia el advertising, disparo el timer para entrar en estado deep sleep.
            tempSensor.go_sleep(5);
        }
        break;
...
void app_main(void)
{
    ...
    // Inicializa el sensor simulado y muestra la temperatura que va teniendo.
    ...
    // Pide la mac a la API del ESP32 y la muestra en el monitor.
    // De aqui podemos tomarla para configurarla dentro del código del HUB
    uint8_t esp_ble_mac[10];
    esp_read_mac(&esp_ble_mac, ESP_MAC_BT);
    esp_log_buffer_hex(GATTS_TABLE_TAG, &esp_ble_mac, 6);
